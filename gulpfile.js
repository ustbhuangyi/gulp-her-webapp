...
gulp.task('css:compile', function () {
  return gulp.src(path.css.src)
    ...
    .pipe($.if(/styl$/, $.stylus({errors: true})))
    .pipe($.cssExpand());
});
...
gulp.task('compile', ['js:compile', 'css:compile', 'tpl:compile', 'image:compile', 'lib:compile', 'smarty:copy', 'plugin:copy', 'php:copy'], function () {
  compileDone();
});
